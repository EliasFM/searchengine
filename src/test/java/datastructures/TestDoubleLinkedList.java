...
public class TestDoubleLinkedList extends BaseTest {
    ...
    @Test(timeout=SECOND)
    public void testDeleteEndElement() {
        IList<String> list = makeBasicList();
        list.delete(2);
    ...
    @Test(timeout=SECOND)
    public void testDeleteAddMultiple() {
        IList<String> list = new DoubleLinkedList<>();
        list.add("foo");
        list.add("bar");
        list.delete(0);
        ...
        list.add("bar");
        list.delete(1);
        assertListMatches(new String[] {"bar", "bar"}, list);
        
        list.add("help");
        list.add("me");
        list.delete(1);
        assertListMatches(new String[] {"bar", "help", "me"}, list);
    }
    
    @Test(timeout=SECOND)
    public void testDeleteTooMany() {
        IList<String> list = new DoubleLinkedList<>();
        list.add("foo");
        list.add("bar");
        list.delete(0);
    ...
    public void testDeleteBack() {
        ...
        assertEquals((cap - 2) * 2, list.get(cap - 2));
    ...
    public void testDeleteReturn() {
        ...
        list.add("foo");
        list.add("bar");
        assertEquals("foo", list.delete(0));
        assertEquals("bar", list.delete(0));
    ...
    @Test(timeout=15*SECOND)
    public void testDeleteAtEndEfficiency() {
        IList<Integer> list = new DoubleLinkedList<>();
        for (int i = 0; i < 10000000; i++) {
            list.add(i);
        }
    ...
    @Test(timeout=5*SECOND)
    public void testDeleteAlternateEfficiency() {
        IList<Integer> list = new DoubleLinkedList<>();
